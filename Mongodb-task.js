...
db("zen class").collection("zen class programme");
...
db.users.insertMany([
  {
    user_id: 1,
    name: "Abdul",
    email: "kaazees88@gmail.com",
  },
  {
    user_id: 2,
    name: "Azeez",
    email: "kaazee31@gmail.com",
  },
  {
    user_id: 3,
    name: "sahul",
    email: "sahul588@gmail.com",
  },
  {
    user_id: 4,
    name: "farith",
    email: "farith45@gmail.com",
  },
]);
...
db.codekata.insertMany([
  ...
  {
    user_id: 2,
    codekata_title: "pattern",
    codekata_problems: 30,
  },
  {
    user_id: 1,
    codekata_title: "advance",
    codekata_problems: 5,
  },
  {
    user_id: 1,
    codekata_title: "array",
    codekata_problems: 45,
  },
]);
...
// 7.To create and insert data for mentor
...
// 8.To create and insert data for companydrive

db.companydrives.insertMany([
  {
    user_id: 1,
    drive_date: new Date("2021-02-18"),
    company_name: "Amazon",
  },
  {
    user_id: 2,
    drive_date: new Date("2020-10-13"),
    company_name: "Zoho",
  },
  {
    user_id: 3,
